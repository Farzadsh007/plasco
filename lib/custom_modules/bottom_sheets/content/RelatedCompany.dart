...
class RelatedCompanyWidget extends StatefulWidget {
  RelatedCompanyWidget({Key key, this.company }) : super(key: key);

  final Company company;

  @override
  _RelatedCompanyWidgetState createState() =>
      _RelatedCompanyWidgetState(this.company );
}

class _RelatedCompanyWidgetState extends State<RelatedCompanyWidget> {
  _RelatedCompanyWidgetState(this.company );
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      children: [
        ...
        MyDropDownFormField(
          httpEvent: DropDownCommunicationTypeEvent(),
          ...
          fontSize: 12,
          onChange: (newValue) {
            this.connectionType = newValue.id;
          },
        ),
        Padding(
            ...
            children: [
              ...
              Expanded(
                child: FractionallySizedBox(
                    ...
                    widthFactor: 1,
                    child: MyButton(
                        text: Strings.BottomSheetWidgetRelatedCompany_send,
                        buttonFill: ButtonFillStyle.Yellow,
                        onPressed: () {
                          if( _formKey.currentState.validate()){
                            locator<Web>().post(
                                RelatedCompanyAddEvent(
                                    httpBloc, this.company, this.connectionType),
                                context);
                          }
